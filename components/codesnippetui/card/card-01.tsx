...
const defaultProps: Card01Props = {
    ...
    content: {
        text: "Just launched CodeShad! Check out the documentation and let me know what you think 🎨",
        link: {
            title: "CodeShad Documentation",
            description: "A comprehensive guide to CodeShad",
