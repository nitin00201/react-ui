...
```bash tab="bun"
bunx shadcn@latest add http://localhost:3000/r/utils.json 
```
 
```bash tab="npx"
npx shadcn@latest add http://localhost:3000/r/utils.json
```
...
```bash tab="bun"
bunx shadcn@latest add http://localhost:3000/r/card-05.json
```
 
```bash tab="npx"
npx shadcn@latest add http://localhost:3000/r/card-05.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add http://localhost:3000/r/card-05.json
```
...
```bash tab="bun"
bunx shadcn@latest add http://localhost:3000/r/ai-card-generation.json
```
 
```bash tab="npx"
npx shadcn@latest add http://localhost:3000/r/ai-card-generation.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add http://localhost:3000/r/ai-card-generation.json
```
...
```bash tab="bun"
bunx shadcn@latest add http://localhost:3000/r/card-05.json -c ./apps/www
```
 
```bash tab="npx"
npx shadcn@latest add http://localhost:3000/r/card-05.json -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add http://localhost:3000/r/card-05.json -c ./apps/www
```
